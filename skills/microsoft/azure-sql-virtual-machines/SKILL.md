...
| Configuration | L103-L144 | Configuring SQL Server on Azure VMs: HA/DR (AGs, FCIs, listeners, load balancers), storage and tempdb layout, IaaS Agent setup, backups, editions/versions, and connectivity options. |
